...
public class r_customer : MetroForm
{
	private string gid = "";
	...
	private void bindgrid()
	{
		...
		try
		{
			...
			try
			{
				...
				((DbCommand)(object)val2).CommandText = "select * from r_customer where name like '" + ((Control)metroTextBox5).Text + "%'";
	...
	private void r_customer_Load(object sender, EventArgs e)
	{
		((Control)this).Focus();
		((Form)this).Activate();
	}
	...
	private void metroTextBox1_Validating(object sender, CancelEventArgs e)
	{
		...
		{
			errorProvider1.SetError((Control)(object)metroTextBox1, "Enter customer Name");
			e.Cancel = true;
		}
	}
	...
	private void SaveMethod()
	{
		...
		if (new USER_PERMISSION().Permission("1", "Insert"))
		{
			if (((ContainerControl)this).ValidateChildren())
			{
				try
				{
					...
					try
					{
						...
						try
						{
							val2.Connection = val;
							((DbConnection)(object)val).Open();
							((DbCommand)(object)val2).CommandText = "insert into r_customer(name,mobileno,address,emailid,balance) values('" + ((Control)metroTextBox1).Text + "','" + ((Control)metroTextBox2).Text + "','" + ((Control)metroTextBox4).Text + "','" + ((Control)metroTextBox3).Text + "','" + ((Control)metroTextBox6).Text + "')";
							((DbCommand)(object)val2).ExecuteNonQuery();
							((DbConnection)(object)val).Close();
							bindgrid();
							ResetMethod();
							if (1 == (int)MetroMessageBox.Show((IWin32Window)(object)this, "Customer Added Successfully", "Done", (MessageBoxButtons)0, (MessageBoxIcon)64))
							{
								((Control)this).Focus();
								((Form)this).Activate();
							}
				...
				{
					if (1 == (int)MetroMessageBox.Show((IWin32Window)(object)this, "Customer Name already Taken", "Error", (MessageBoxButtons)0, (MessageBoxIcon)16))
					{
						((Control)this).Focus();
						((Form)this).Activate();
					}
	...
	private void metroTextBox2_Validating(object sender, CancelEventArgs e)
	{
		...
		{
			errorProvider1.SetError((Control)(object)metroTextBox2, "Enter mobile No");
			e.Cancel = true;
		}
	}
	...
	{
		if (((Control)metroTextBox3).Text != "" && !new RegualarExpress().emailfield(((Control)metroTextBox3).Text))
		{
			errorProvider1.SetError((Control)(object)metroTextBox3, "Enter valid Emailid");
			e.Cancel = true;
		}
	}
	...
	private void ImportMethod()
	{
		...
		//IL_0774: Invalid comparison between I4 and Unknown
					...
					try
					{
						...
						try
						{
							...
							try
							{
								...
								((DbCommand)(object)val3).CommandText = "insert into r_customer(name,mobileno,address,emailid,balance) values('" + text + "','" + text2 + "','" + text4 + "','" + text3 + "','" + text5 + "')";
	...
	private void UpdateMethod()
	{
		...
		if (new USER_PERMISSION().Permission("1", "Update"))
		{
			if (gid != "")
			{
				if (((ContainerControl)this).ValidateChildren())
					...
					try
					{
						...
						try
						{
							...
							try
							{
								val2.Connection = val;
								((DbConnection)(object)val).Open();
								((DbCommand)(object)val2).CommandText = "update r_customer set name='" + ((Control)metroTextBox1).Text + "',mobileno='" + ((Control)metroTextBox2).Text + "',address='" + ((Control)metroTextBox4).Text + "',emailid='" + ((Control)metroTextBox3).Text + "',balance='" + ((Control)metroTextBox6).Text + "' where id='" + gid + "'";
								((DbCommand)(object)val2).ExecuteNonQuery();
								((DbConnection)(object)val).Close();
								bindgrid();
								ResetMethod();
								if (1 == (int)MetroMessageBox.Show((IWin32Window)(object)this, "Customer Updated Successfully", "Done", (MessageBoxButtons)0, (MessageBoxIcon)64))
								{
									((Control)this).Focus();
									((Form)this).Activate();
								}
	...
	private void DeleteMethod()
	{
		...
		if (new USER_PERMISSION().Permission("1", "Delete"))
		{
			if (gid != "")
			{
					...
					try
					{
						...
						try
						{
							...
							try
							{
								val2.Connection = val;
								((DbConnection)(object)val).Open();
								string commandText = "delete from r_customer where id='" + gid + "'";
								((DbCommand)(object)val2).CommandText = commandText;
								((DbCommand)(object)val2).ExecuteNonQuery();
								((DbConnection)(object)val).Close();
								bindgrid();
								ResetMethod();
								if (1 == (int)MetroMessageBox.Show((IWin32Window)(object)this, "Customer Deleted Successfully", "Done", (MessageBoxButtons)0, (MessageBoxIcon)64))
								{
									((Control)this).Focus();
									((Form)this).Activate();
								}
	...
	private void r_customer_FormClosed(object sender, FormClosedEventArgs e)
	{
	}
	...
	private void metroTextBox6_Validating(object sender, CancelEventArgs e)
	{
		...
		{
			errorProvider1.SetError((Control)(object)metroTextBox6, "Enter Valid Balance");
			e.Cancel = true;
		}
	}
	...
	private void r_customer_FormClosing(object sender, FormClosingEventArgs e)
	{
		((Control)Functions.static_mainform).Focus();
		((Form)Functions.static_mainform).Activate();
	}
	...
	private void InitializeComponent()
	{
		...
		ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(r_customer));
		...
		((Control)groupBox1).Size = new Size(332, 549);
		((Control)groupBox1).TabIndex = 0;
		groupBox1.TabStop = false;
		((Control)groupBox1).Text = "Customer Information";
		metroTextBox6.CustomButton.Image = null;
		((Control)metroTextBox6.CustomButton).Location = new Point(267, 1);
		...
		((Control)metroTextBox6).Size = new Size(295, 29);
		((Control)metroTextBox6).TabIndex = 4;
		metroTextBox6.UseSelectable = true;
		metroTextBox6.WaterMark = "Enter Opening Balance";
		...
		((Control)groupBox2).Location = new Point(25, 254);
		((Control)groupBox2).Name = "groupBox2";
		((Control)groupBox2).Size = new Size(276, 262);
		...
		((Control)button4).Location = new Point(33, 178);
		((Control)button4).Name = "button4";
		((Control)button4).Size = new Size(193, 41);
		...
		((Control)button3).Location = new Point(33, 131);
		((Control)button3).Name = "button3";
		((Control)button3).Size = new Size(193, 41);
		...
		((Control)button2).Location = new Point(33, 84);
		((Control)button2).Name = "button2";
		((Control)button2).Size = new Size(193, 41);
		...
		((Control)button1).Location = new Point(33, 37);
		((Control)button1).Name = "button1";
		((Control)button1).Size = new Size(193, 41);
		...
		((Control)metroTextBox4.CustomButton).Location = new Point(267, 1);
		...
		((Control)metroTextBox4).Location = new Point(15, 157);
		...
		((Control)metroTextBox4).Size = new Size(295, 29);
		...
		((Control)metroTextBox3.CustomButton).Location = new Point(267, 1);
		...
		((Control)metroTextBox3).Location = new Point(15, 120);
		...
		((Control)metroTextBox3).Size = new Size(295, 29);
		...
		((Control)metroTextBox2.CustomButton).Location = new Point(267, 1);
		...
		((Control)metroTextBox2).Location = new Point(15, 83);
		...
		((Control)metroTextBox2).Size = new Size(295, 29);
		...
		((Control)metroTextBox1.CustomButton).Location = new Point(267, 1);
		...
		((Control)metroTextBox1).Location = new Point(15, 46);
		...
		((Control)metroTextBox1).Size = new Size(295, 29);
		...
		((Control)metroGrid1).Location = new Point(364, 109);
		...
		((Control)metroGrid1).Size = new Size(863, 503);
		...
		((DataGridViewColumn)Column4).HeaderText = "Email Id";
		((DataGridViewColumn)Column4).Name = "Column4";
		((DataGridViewBand)Column4).ReadOnly = true;
		((DataGridViewColumn)Column4).Width = 180;
		...
		((DataGridViewColumn)Balance).HeaderText = "Balance";
		((DataGridViewColumn)Balance).Name = "Balance";
		((DataGridViewBand)Balance).ReadOnly = true;
		metroTextBox5.CustomButton.Image = (Image)(object)Resources.search_34;
		((Control)metroTextBox5.CustomButton).Location = new Point(357, 1);
		...
		((Control)metroTextBox5).Location = new Point(361, 74);
		metroTextBox5.MaxLength = 32767;
		((Control)metroTextBox5).Name = "metroTextBox5";
		metroTextBox5.PasswordChar = '\0';
		metroTextBox5.PromptText = "Search Customer Name Here . . .";
		...
		((Control)metroTextBox5).Size = new Size(385, 29);
		((Control)metroTextBox5).TabIndex = 5;
		metroTextBox5.UseSelectable = true;
		metroTextBox5.WaterMark = "Search Customer Name Here . . .";
		...
		((Control)button5).BackColor = Color.FromArgb(0, 192, 0);
		...
		((Control)button5).Location = new Point(752, 63);
		((Control)button5).Name = "button5";
		((Control)button5).Size = new Size(193, 41);
		...
		((Control)button6).Location = new Point(971, 62);
		((Control)button6).Name = "button6";
		((Control)button6).Size = new Size(193, 41);
		...
		((Form)this).ClientSize = new Size(1243, 624);
		...
		((Control)this).Name = "r_customer";
		((MetroForm)this).Resizable = false;
		((Control)this).Text = "Customer Management";
		((Form)this).FormClosing += new FormClosingEventHandler(r_customer_FormClosing);
		((Form)this).FormClosed += new FormClosedEventHandler(r_customer_FormClosed);
		((Form)this).Load += r_customer_Load;
