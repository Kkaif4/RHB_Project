...
public class h_referedby : MetroForm
{
	private string gid = "";
				...
				try
				{
					...
					try
					{
						...
						try
						{
							...
							((DbCommand)(object)val3).CommandText = "insert into h_refered_bu(ref_by) values('" + text + "')";
	...
	public void bindall()
	{
		...
		try
		{
			...
			try
			{
				...
				((DbCommand)(object)val2).CommandText = "select * from h_refered_bu where ref_by like '" + ((Control)metroTextBox1).Text + "%'";
			...
			try
			{
				...
				try
				{
					...
					try
					{
						val2.Connection = val;
						((DbConnection)(object)val).Open();
						((DbCommand)(object)val2).CommandText = "insert into h_refered_bu(ref_by) values('" + ((Control)metroTextBox2).Text + "')";
				...
				try
				{
					...
					try
					{
						...
						try
						{
							val2.Connection = val;
							((DbConnection)(object)val).Open();
							((DbCommand)(object)val2).CommandText = "update h_refered_bu set ref_by='" + ((Control)metroTextBox2).Text + "' where id='" + gid + "'";
							((DbCommand)(object)val2).ExecuteNonQuery();
							((DbConnection)(object)val).Close();
							bindall();
			...
			if (6 == (int)MetroMessageBox.Show((IWin32Window)(object)this, "Are you sure want to delete record", "Confirm?", (MessageBoxButtons)4, (MessageBoxIcon)32))
			{
				...
				try
				{
					...
					try
					{
						val2.Connection = val;
						((DbConnection)(object)val).Open();
						((DbCommand)(object)val2).CommandText = "delete from h_refered_bu where id='" + gid + "'";
						((DbCommand)(object)val2).ExecuteNonQuery();
						((DbConnection)(object)val).Close();
						((Control)metroTextBox2).Text = "";
						gid = "";
	...
	private void InitializeComponent()
	{
		...
		metroTextBox2.PromptText = "Refered By";
		...
		metroTextBox2.WaterMark = "Refered By";
		...
		metroTextBox1.PromptText = "Search Refered By";
		...
		metroTextBox1.WaterMark = "Search Refered By";
		...
		((Control)this).Text = "Guest Refered By";
