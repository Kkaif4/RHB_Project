...
public class h_Plan_charge : MetroForm
{
	private string gid = "";
	...
	private void BindGrid()
	{
		...
		try
		{
			...
			try
			{
				...
				((DbCommand)(object)val2).CommandText = "select * from h_plan_type where plan_name like '" + ((Control)metroTextBox1).Text + "%'";
	...
	private void h_Plan_charge_Load(object sender, EventArgs e)
	{
		((Control)this).Focus();
		((Form)this).Activate();
	}
	...
	private void metroTextBox2_Validating(object sender, CancelEventArgs e)
	{
		...
		{
			errorProvider1.SetError((Control)(object)metroTextBox2, "Enter Valid Name");
			e.Cancel = true;
		}
	}
	...
	private void metroTextBox3_Validating(object sender, CancelEventArgs e)
	{
		...
		{
			errorProvider1.SetError((Control)(object)metroTextBox3, "Enter Valid Charge");
			e.Cancel = true;
		}
	}
	...
	private void SaveFunction()
	{
		...
		//IL_00bc: Invalid comparison between I4 and Unknown
			...
			try
			{
				...
				try
				{
					...
					try
					{
						val2.Connection = val;
						((DbConnection)(object)val).Open();
						((DbCommand)(object)val2).CommandText = "insert into h_plan_type(plan_name,charge) values('" + ((Control)metroTextBox2).Text + "','" + ((Control)metroTextBox3).Text + "')";
						((DbCommand)(object)val2).ExecuteNonQuery();
						((DbConnection)(object)val).Close();
						ResetMethod();
						if (1 == (int)MetroMessageBox.Show((IWin32Window)(object)this, "Plan Added Successfully", "Done", (MessageBoxButtons)0, (MessageBoxIcon)64))
						{
							((Control)this).Focus();
							((Form)this).Activate();
						}
			...
			if (6 == (int)MetroMessageBox.Show((IWin32Window)(object)this, "Are you sure want to delete record", "Confirm?", (MessageBoxButtons)4, (MessageBoxIcon)32))
			{
				...
				try
				{
					...
					try
					{
						val2.Connection = val;
						((DbConnection)(object)val).Open();
						((DbCommand)(object)val2).CommandText = "delete from h_plan_type where id='" + gid + "'";
						((DbCommand)(object)val2).ExecuteNonQuery();
						((DbConnection)(object)val).Close();
						ResetMethod();
						if (1 == (int)MetroMessageBox.Show((IWin32Window)(object)this, "Plan information deleted", "Done", (MessageBoxButtons)0, (MessageBoxIcon)64))
						{
							((Control)this).Focus();
							((Form)this).Activate();
						}
	...
	private void updateFunction()
	{
		...
		//IL_0179: Invalid comparison between I4 and Unknown
		//IL_0042: Unknown result type (might be due to invalid IL or missing references)
		//IL_0048: Expected O, but got Unknown
		//IL_0049: Unknown result type (might be due to invalid IL or missing references)
		//IL_004f: Expected O, but got Unknown
		//IL_00de: Unknown result type (might be due to invalid IL or missing references)
		//IL_00e3: Invalid comparison between I4 and Unknown
		if (gid != "")
		{
			if (((ContainerControl)this).ValidateChildren())
			{
				try
				{
					...
					try
					{
						...
						try
						{
							val2.Connection = val;
							((DbConnection)(object)val).Open();
							((DbCommand)(object)val2).CommandText = "update h_plan_type set plan_name='" + ((Control)metroTextBox2).Text + "',charge='" + ((Control)metroTextBox3).Text + "' where id='" + gid + "'";
							((DbCommand)(object)val2).ExecuteNonQuery();
							((DbConnection)(object)val).Close();
							if (1 == (int)MetroMessageBox.Show((IWin32Window)(object)this, "Plan Updated Successfully", "Done", (MessageBoxButtons)0, (MessageBoxIcon)64))
							{
								((Control)this).Focus();
								((Form)this).Activate();
							}
				...
				{
					if (1 == (int)MetroMessageBox.Show((IWin32Window)(object)this, "Plan Name Already Avaliable", "Error", (MessageBoxButtons)0, (MessageBoxIcon)16))
					{
						((Control)this).Focus();
						((Form)this).Activate();
					}
	...
	private void metroGrid1_CellClick(object sender, DataGridViewCellEventArgs e)
	{
		...
		((Control)metroTextBox3).Text = ((DataGridView)metroGrid1).SelectedRows[0].Cells[2].Value.ToString();
	}
	...
	private void h_Plan_charge_FormClosed(object sender, FormClosedEventArgs e)
	{
		((Control)Functions.static_mainform).Focus();
		((Form)Functions.static_mainform).Activate();
	}
	...
	private void InitializeComponent()
	{
		...
		((Control)metroTextBox1.CustomButton).Location = new Point(264, 1);
		...
		metroTextBox1.PromptText = "Search Plan Name";
		...
		((Control)metroTextBox1).Size = new Size(292, 29);
		((Control)metroTextBox1).TabIndex = 0;
		metroTextBox1.UseSelectable = true;
		metroTextBox1.WaterMark = "Search Plan Name";
		...
		((Control)metroGrid1).Location = new Point(24, 97);
		...
		((Control)metroGrid1).Size = new Size(290, 319);
		...
		((DataGridViewColumn)Column2).HeaderText = "Plan Name";
		...
		((DataGridViewColumn)Column3).HeaderText = "Charges";
		...
		((Control)button1).Location = new Point(25, 492);
		((Control)button1).Name = "button1";
		((Control)button1).Size = new Size(116, 39);
		...
		((Control)button2).Location = new Point(187, 492);
		((Control)button2).Name = "button2";
		((Control)button2).Size = new Size(118, 39);
		...
		((Control)button3).Location = new Point(25, 543);
		((Control)button3).Name = "button3";
		((Control)button3).Size = new Size(116, 39);
		...
		((Control)button4).Location = new Point(187, 543);
		((Control)button4).Name = "button4";
		((Control)button4).Size = new Size(118, 39);
		...
		((Control)metroTextBox2.CustomButton).Location = new Point(264, 1);
		...
		((Control)metroTextBox2).Size = new Size(292, 29);
		((Control)metroTextBox2).TabIndex = 2;
		metroTextBox2.UseSelectable = true;
		metroTextBox2.WaterMark = "Enter Plan Name";
		...
		((Control)metroTextBox3.CustomButton).Location = new Point(264, 1);
		...
		((Control)metroTextBox3).Size = new Size(292, 29);
		((Control)metroTextBox3).TabIndex = 3;
		metroTextBox3.UseSelectable = true;
		metroTextBox3.WaterMark = "Enter Plan Charge";
		...
		((Form)this).ClientSize = new Size(338, 595);
		...
		((Control)this).Name = "h_Plan_charge";
		((MetroForm)this).Resizable = false;
		((Control)this).Text = "Plan Charge";
		((Form)this).FormClosed += new FormClosedEventHandler(h_Plan_charge_FormClosed);
		((Form)this).Load += h_Plan_charge_Load;
