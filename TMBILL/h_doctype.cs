...
public class h_doctype : MetroForm
{
	...
	private void InitializeComponent()
	{
		...
		metroTextBox2.PromptText = "Enter Document Type";
		...
		metroTextBox2.WaterMark = "Enter Document Type";
		...
		((Control)metroGrid1).Size = new Size(399, 365);
		...
		((Control)button1).Location = new Point(292, 53);
		...
		metroTextBox1.PromptText = "Search Document Type";
		...
		metroTextBox1.WaterMark = "Search Document Type";
		...
		((DataGridViewColumn)Column2).HeaderText = "Document Type";
		...
		((Form)this).ClientSize = new Size(457, 571);
		...
		((Control)this).Name = "h_referedby";
		((MetroForm)this).Resizable = false;
		((Control)this).Text = "Guest Document Type";
	...
	private void ImportMethod()
	{
		...
		try
		{
				...
				try
				{
					...
					try
					{
						...
						try
						{
							...
							((DbCommand)(object)val3).CommandText = "insert into h_doc_type(doc_type) values('" + text + "')";
			...
			thread.Abort();
			if (1 == (int)MetroMessageBox.Show((IWin32Window)(object)this, "Document Type Added Successfully", "Done", (MessageBoxButtons)0, (MessageBoxIcon)64))
			{
				((Control)this).Focus();
				((Form)this).Activate();
			}
	...
	public void bindall()
	{
		...
		try
		{
			...
			try
			{
				...
				((DbCommand)(object)val2).CommandText = "select * from h_doc_type where doc_type like '" + ((Control)metroTextBox1).Text + "%'";
	...
	private void metroTextBox2_Validating(object sender, CancelEventArgs e)
	{
		...
		{
			errorProvider1.SetError((Control)(object)metroTextBox2, "Enter Document type");
			e.Cancel = true;
		}
	}
	...
	private void SaveFunction()
	{
		...
		if (((ContainerControl)this).ValidateChildren())
		{
			try
			{
				...
				try
				{
					...
					try
					{
						val2.Connection = val;
						((DbConnection)(object)val).Open();
						((DbCommand)(object)val2).CommandText = "insert into h_doc_type(doc_type) values('" + ((Control)metroTextBox2).Text + "')";
			...
			{
				if (1 == (int)MetroMessageBox.Show((IWin32Window)(object)this, "Document type Already Avaliable", "Error", (MessageBoxButtons)0, (MessageBoxIcon)16))
				{
					((Control)this).Focus();
					((Form)this).Activate();
				}
				...
				try
				{
					...
					try
					{
						...
						try
						{
							val2.Connection = val;
							((DbConnection)(object)val).Open();
							((DbCommand)(object)val2).CommandText = "update h_doc_type set doc_type='" + ((Control)metroTextBox2).Text + "' where id='" + gid + "'";
							((DbCommand)(object)val2).ExecuteNonQuery();
							((DbConnection)(object)val).Close();
							bindall();
							if (1 == (int)MetroMessageBox.Show((IWin32Window)(object)this, "Document Type Updated Successfully", "Done", (MessageBoxButtons)0, (MessageBoxIcon)64))
							{
								((Control)metroTextBox2).Text = "";
								((Control)this).Focus();
								((Form)this).Activate();
			...
			if (6 == (int)MetroMessageBox.Show((IWin32Window)(object)this, "Are you sure want to delete record", "Confirm?", (MessageBoxButtons)4, (MessageBoxIcon)32))
			{
				...
				try
				{
					...
					try
					{
						val2.Connection = val;
						((DbConnection)(object)val).Open();
						((DbCommand)(object)val2).CommandText = "delete from h_doc_type where id='" + gid + "'";
						((DbCommand)(object)val2).ExecuteNonQuery();
						((DbConnection)(object)val).Close();
						((Control)metroTextBox2).Text = "";
						gid = "";
						ResetMethod();
						bindall();
						if (1 == (int)MetroMessageBox.Show((IWin32Window)(object)this, "Document Type deleted", "Done", (MessageBoxButtons)0, (MessageBoxIcon)64))
						{
							((Control)this).Focus();
							((Form)this).Activate();
						}
