...
[ToolboxItem(true)]
public class r_invoiceTableAdapter : Component
{
	...
	private void InitAdapter()
	{
		...
		dataTableMapping.DataSetTable = "r_invoice";
		...
		((DbCommand)(object)_adapter.InsertCommand).CommandText = "INSERT INTO [dbo].[r_invoice] ([waitername], [customername], [total], [selectedtax], [isigst], [igst], [cgst], [sgst], [totalwithtax], [discounttype], [discountamt], [grandtotal], [paymenttype], [tablename], [mydate], [inwords], [paidamt], [remainingamt], [extra_tax_s], [extra_tax_amt], [extra_tax_tot]) VALUES (@waitername, @customername, @total, @selectedtax, @isigst, @igst, @cgst, @sgst, @totalwithtax, @discounttype, @discountamt, @grandtotal, @paymenttype, @tablename, @mydate, @inwords, @paidamt, @remainingamt, @extra_tax_s, @extra_tax_amt, @extra_tax_tot)";
	...
	private void InitCommandCollection()
	{
		...
		((DbCommand)(object)_commandCollection[0]).CommandText = "SELECT id, waitername, customername, total, selectedtax, isigst, igst, cgst, sgst, totalwithtax, discounttype, discountamt, grandtotal, paymenttype, tablename, mydate, inwords, paidamt, remainingamt, extra_tax_s, extra_tax_amt, extra_tax_tot FROM dbo.r_invoice";
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
	public virtual int Fill(DataSet_DINEIN.r_invoiceDataTable dataTable)
	{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
	public virtual DataSet_DINEIN.r_invoiceDataTable GetData()
	{
		Adapter.SelectCommand = CommandCollection[0];
		DataSet_DINEIN.r_invoiceDataTable r_invoiceDataTable = new DataSet_DINEIN.r_invoiceDataTable();
		((DbDataAdapter)(object)Adapter).Fill((DataTable)r_invoiceDataTable);
	...
	[HelpKeyword("vs.data.TableAdapter")]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
	public virtual int Update(DataSet_DINEIN.r_invoiceDataTable dataTable)
	{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
	public virtual int Update(DataSet_DINEIN dataSet)
	{
		return ((DbDataAdapter)(object)Adapter).Update((DataSet)dataSet, "r_invoice");
	}
	...
	public virtual int Insert(string waitername, string customername, string total, string selectedtax, string isigst, string igst, string cgst, string sgst, string totalwithtax, string discounttype, string discountamt, string grandtotal, string paymenttype, string tablename, string mydate, string inwords, string paidamt, string remainingamt, string extra_tax_s, string extra_tax_amt, string extra_tax_tot)
	{
		...
		{
			((DbParameter)(object)Adapter.InsertCommand.Parameters[13]).Value = tablename;
		}
		if (mydate == null)
		{
		...
		{
			((DbParameter)(object)Adapter.InsertCommand.Parameters[14]).Value = mydate;
		}
		if (inwords == null)
		{
		...
		{
			((DbParameter)(object)Adapter.InsertCommand.Parameters[15]).Value = inwords;
		}
		if (paidamt == null)
		{
		...
		{
			((DbParameter)(object)Adapter.InsertCommand.Parameters[16]).Value = paidamt;
		}
		...
		{
			((DbParameter)(object)Adapter.InsertCommand.Parameters[17]).Value = remainingamt;
		}
		if (extra_tax_s == null)
		{
