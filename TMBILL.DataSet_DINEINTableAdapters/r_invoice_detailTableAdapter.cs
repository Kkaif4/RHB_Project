...
public class r_invoice_detailTableAdapter : Component
{
	...
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
	[DebuggerNonUserCode]
	public r_invoice_detailTableAdapter()
	{
	...
	private void InitAdapter()
	{
		...
		dataTableMapping.DataSetTable = "r_invoice_detail";
		...
		((DbCommand)(object)_adapter.InsertCommand).CommandText = "INSERT INTO [dbo].[r_invoice_detail] ([invoice_id], [itemname], [qty], [price], [total]) VALUES (@invoice_id, @itemname, @qty, @price, @total)";
	...
	private void InitCommandCollection()
	{
		...
		((DbCommand)(object)_commandCollection[0]).CommandText = "SELECT id, invoice_id, itemname, qty, price, total FROM dbo.r_invoice_detail";
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
	public virtual int Fill(DataSet_DINEIN.r_invoice_detailDataTable dataTable)
	{
	...
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
	[HelpKeyword("vs.data.TableAdapter")]
	public virtual DataSet_DINEIN.r_invoice_detailDataTable GetData()
	{
		Adapter.SelectCommand = CommandCollection[0];
		DataSet_DINEIN.r_invoice_detailDataTable r_invoice_detailDataTable = new DataSet_DINEIN.r_invoice_detailDataTable();
		((DbDataAdapter)(object)Adapter).Fill((DataTable)r_invoice_detailDataTable);
	...
	[HelpKeyword("vs.data.TableAdapter")]
	[DebuggerNonUserCode]
	public virtual int Update(DataSet_DINEIN.r_invoice_detailDataTable dataTable)
	{
	...
	{
		return ((DbDataAdapter)(object)Adapter).Update((DataSet)dataSet, "r_invoice_detail");
	}
