...
[DataObject(true)]
public class r_invoice_home_detailTableAdapter : Component
{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
	public r_invoice_home_detailTableAdapter()
	{
	...
	private void InitAdapter()
	{
		...
		dataTableMapping.DataSetTable = "r_invoice_home_detail";
		...
		((DbCommand)(object)_adapter.InsertCommand).CommandText = "INSERT INTO [dbo].[r_invoice_home_detail] ([invoice_id], [itemname], [qty], [price], [total]) VALUES (@invoice_id, @itemname, @qty, @price, @total)";
	...
	private void InitCommandCollection()
	{
		...
		((DbCommand)(object)_commandCollection[0]).CommandText = "SELECT id, invoice_id, itemname, qty, price, total FROM dbo.r_invoice_home_detail";
	...
	[DebuggerNonUserCode]
	[HelpKeyword("vs.data.TableAdapter")]
	public virtual int Fill(DataSet_HOMEDELIVERY.r_invoice_home_detailDataTable dataTable)
	{
	...
	[HelpKeyword("vs.data.TableAdapter")]
	public virtual DataSet_HOMEDELIVERY.r_invoice_home_detailDataTable GetData()
	{
		Adapter.SelectCommand = CommandCollection[0];
		DataSet_HOMEDELIVERY.r_invoice_home_detailDataTable r_invoice_home_detailDataTable = new DataSet_HOMEDELIVERY.r_invoice_home_detailDataTable();
		((DbDataAdapter)(object)Adapter).Fill((DataTable)r_invoice_home_detailDataTable);
	...
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
	[HelpKeyword("vs.data.TableAdapter")]
	public virtual int Update(DataSet_HOMEDELIVERY.r_invoice_home_detailDataTable dataTable)
	{
	...
	{
		return ((DbDataAdapter)(object)Adapter).Update((DataSet)dataSet, "r_invoice_home_detail");
	}
